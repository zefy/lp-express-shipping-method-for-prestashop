...
*}
{l s='LP EXPRESS TERMINAL:' mod='lpexpress'} {$terminal['name']|escape:'htmlall':'UTF-8'}, {$terminal['address']|escape:'htmlall':'UTF-8'}, {$terminal['city']|escape:'htmlall':'UTF-8'}<br /><br />